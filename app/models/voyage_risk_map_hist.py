...
class VoyageRiskMapHist(Base):
    ...
    voyage_risk_map_id: Mapped[str] = mapped_column(primary_key=True, index=True)
    ...
    tidal_current_speed: Mapped[float] = mapped_column()
    tidal_current_direction: Mapped[float] = mapped_column()
    typhoon_longitude: Mapped[float] = mapped_column()
    typhoon_latitude: Mapped[float] = mapped_column()
    typhoon_grade: Mapped[float] = mapped_column()
